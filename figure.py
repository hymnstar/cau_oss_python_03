...
class line:
    #클래스에 대한 설명은 class 선언 바로 아래에 위치합니다.

    #line class는 선의 길이에 대해 저장하고 있는 클래스입니다.
    #변수로는 외부에서 접근 불가능한 __length가 있으며,
    #해당 변수를 수정하고 접근하기 위해
    #set length와, get_lenght 메소드를 제공합니다.

    __length = 0
    def __init__(self, length):
        #생성자 초기 lenght 값을 받습니다.
        #Args:
        #    lenght (int or float): 초기 선의 길이 값입니다.
